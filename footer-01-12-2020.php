                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                    <div class="wow fadeIn footer-news">
                        ...
                        <div class="footer-news-box">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-1.jpg') ?>" alt="">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-2.jpg') ?>" alt="">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-3.jpg') ?>" alt="">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-4.jpg') ?>" alt="">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-5.jpg') ?>" alt="">
                            <img src="<?php echo get_theme_file_uri('/images/news/news-6.jpg') ?>" alt="">
