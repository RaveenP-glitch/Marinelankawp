...
<header id="header-top" class="home-header" style="height:100vh">
    ...
    <!--overlay-->
    <div id="home-overlay" style="background: linear-gradient(to right bottom,rgba(0,0,0,.2),rgba(0,0,0,.1));"> </div>
    ...
    <div class="spl-text">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <span style="color:#fff; font-size:1.7rem;font-family : Raleway  ">Highest</span>
                    <h3 class="mt-md-2"> &nbsp; Quality &nbsp; </h3>
                </div>

                <div class="col-md-4">
                    <span style="color:#fff; font-size:1.7rem;font-family : Raleway  ">Continuous</span>
